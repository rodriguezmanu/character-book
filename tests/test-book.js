...
window.testBook = function(frame) {
  ...
  return startTest('Test character book', frame, function(test) {
    ...
    describe('Widget loads with no errors', function() {
      ...
      const Book = new BookCharacter(frame, store);
    ...
    wait(1500).describe('Click character "Chewbacca" in list', function() {
    ...
    wait(4000).describe('Changes saved successfully', function() {
      assertHasText('.details .name', 'Emperor Palpatine');
      assertHasText('.details .species', 'Human');
      assertHasText('.list .item:eq(5) .name', 'Emperor Palpatine');
    });

    wait(1000).describe('Click character "R2-D2" in list', function() {
    ...
    wait(3000).describe('Changes saved successfully', function() {
      assertHasText('.details .name', 'Luke Skywalker');
    ...
    wait(1000).describe('Click on "Darth Bane"', function() {
        clickElement('.list .name:contains("Darth Bane")');
    });

    wait(2000).describe('Click on "BB-8"', function() {
